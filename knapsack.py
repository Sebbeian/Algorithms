...
const val = [10,11,14,6,5,14]; // The value of all available items
const wt = [4,4,5,3,2,6]; // The weights of available items
const W = 10; // The maximum weight we can carry in our collection
const N = val.length;
